...
const copyByLanguage: Record<Language, NotFoundCopy> = {
  ...
  zh: {
    eyebrow: NOT_FOUND_EYEBROW,
    title: "无法找到此页面",
    lead: "链接可能已更改，或者这个公开页面可能已不再在网页上提供。",
    primaryHome: "前往首页",
    primaryJourneys: "查看旅程",
    primaryUsers: "浏览用户",
  },
  es: {
    eyebrow: NOT_FOUND_EYEBROW,
    ...
    primaryUsers: "Explorar personas",
  },
  pt: {
    eyebrow: NOT_FOUND_EYEBROW,
  ...
  vi: {
    ...
    lead: "Liên kết có thể đã thay đổi hoặc trang công khai này có thể không còn hiển thị trên web nữa.",
    primaryHome: "Về trang chủ",
    primaryJourneys: "Xem hành trình",
    primaryUsers: "Khám phá mọi người",
  },
};
