...
const momentLabels: Partial<Record<Language, MomentLabels>> & { en: MomentLabels } = {
  ...
  es: {
    ...
    contextNote: "Este momento forma parte de un viaje publicado. Lo no compartido sigue privado.",
  ...
  pt: {
    ...
    contextNote: "Este momento faz parte de uma jornada publicada. O que nao foi compartilhado continua privado.",
  ...
  fr: {
    ...
    contextNote: "Ce moment fait partie d'un voyage publie. Les moments non partages restent prives.",
  ...
  th: {
    ...
    contextNote: "ช่วงเวลานี้เป็นส่วนหนึ่งของทริปที่เผยแพร่ เนื้อหาที่ไม่แชร์จะยังเป็นส่วนตัว",
  ...
  vi: {
    ...
    contextNote: "Khoanh khac nay thuoc mot hanh trinh da dang. Cac khoanh khac chua chia se van rieng tu.",
