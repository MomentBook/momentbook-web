...
const homeContent: Record<Language, HomeContent> = {
  en: {
    ...
    highlightCards: [
      ...
      },
      {
        ...
        text: "No public feed. No tracking.",
      },
    ],
    ...
    storyListTitle: "Key actions",
    storyList: ["Browse by day", "Browse by place", "Export anytime"],
  ...
  ko: {
    ...
    storyList: ["날짜별 보기", "장소별 보기", "언제든 내보내기"],
  ...
  ja: {
    ...
    storyListTitle: "主な機能",
    storyList: ["日付で見る", "場所で見る", "いつでもエクスポート"],
    previewTitle: "よく使う画面",
