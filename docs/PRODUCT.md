...
## Product Messaging Anchor

웹 카피는 아래 제품 특징을 직접적으로 설명해야 한다.

- 현재/과거의 여정을 **시간과 공간 기준으로 묶어 정리**하는 앱
- 정리된 여정을 통해 **기억을 돕고 회상**할 수 있는 앱
- 정리 결과를 **파일로 저장**하고, **외부 SNS 공유** 또는 **사용자 드라이브 보관**이 가능한 앱
- 시작 방식은 두 가지: **트래킹** 또는 **사진 정리**
- 기본 상태는 **비공개**, 공개는 **선택적 게시**
- 피드 소비가 아니라 **정리된 순간과 여정** 중심
