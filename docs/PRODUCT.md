...
- Hero 섹션: 소개 카피와 2개 CTA(`/{lang}/journeys` 진입, intro video 섹션으로 smooth scroll)를 좌측에 두고, 우측에는 tracking 앱 스크린샷 DeviceMock과 지도/경로 텍스처 배경, 고정 featured journey 메타 카드를 배치한다.
