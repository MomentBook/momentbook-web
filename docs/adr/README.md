...
- Status: Accepted
- Summary: 정적 중심 + route별 revalidate(300/14400) + additive local-time context 우선 렌더링/absolute timestamp fallback + published image browser SW cache + route-group root layouts로 SSR `html lang` 유지(`/{lang}/install` 예외)
...
- Date: 2026-01-29 (updated: 2026-03-31)
- Status: Accepted
