...
const LANDING_COPY: LandingCopy = {
  ...
  sampleFallbackTitle: {
    ...
    zh: "尽量贴合短视频语境的示例旅程",
    es: "Un viaje de ejemplo, ajustado al contexto del short",
    pt: "Uma viagem de exemplo alinhada ao contexto do short",
    fr: "Un voyage d'exemple, si possible aligné au contexte du short",
    th: "ทริปตัวอย่างที่สอดคล้องกับบริบทของช็อตส์ถ้าเป็นไปได้",
    vi: "Chuyến đi mẫu, nếu có thể, khớp với ngữ cảnh của short",
  },
  sampleFallbackLead: {
    ...
    es: "Mostramos un ejemplo por destino y por día para que conecte con el short que acabas de ver.",
    pt: "Mostramos um exemplo por destino e por dia para que ele se conecte ao short que você acabou de ver.",
    fr: "Nous montrons un exemple par destination et par jour pour prolonger naturellement le short que vous venez de voir.",
    th: "แสดงตัวอย่างลำดับรายวันตามจุดหมาย เพื่อให้ต่อเนื่องจากช็อตส์ที่เพิ่งดู",
    vi: "Chúng tôi hiển thị ví dụ theo điểm đến và theo ngày để nối tự nhiên với short bạn vừa xem.",
  },
  finalTitle: {
  ...
  finalLead: {
    ...
    es: "Usa los enlaces oficiales de las tiendas de abajo. En móvil, si hay deep links configurados, la página puede intentar abrir primero la app.",
    pt: "Use os links oficiais das lojas abaixo. No celular, se os deep links estiverem configurados, a página pode tentar abrir o app primeiro.",
    fr: "Utilisez les liens officiels des stores ci-dessous. Sur mobile, si les deep links sont configurés, la page peut d'abord essayer d'ouvrir l'app.",
...
const DESTINATION_SAMPLES: Record<DestinationSampleKey, DestinationSample> = {
  default: {
    ...
    heroLabel: {
      ...
      ja: "ショート文脈の例",
      zh: "短视频语境示例",
      es: "Ejemplo desde el short",
      pt: "Exemplo vindo do short",
      fr: "Exemple lié au short",
      th: "ตัวอย่างตามบริบทจากช็อตส์",
      vi: "Ví dụ theo ngữ cảnh short",
    },
    sectionTitle: {
    ...
    sectionLead: {
      ...
      es: "Cuando el short todavía no muestra el destino, enseñamos primero un ejemplo cercano.",
      pt: "Quando o short ainda não mostra o destino, exibimos primeiro um exemplo próximo.",
      fr: "Quand le short ne transmet pas encore la destination, nous montrons d'abord un exemple proche.",
      th: "ถ้าช็อตส์ยังไม่ได้บอกจุดหมาย เราจะแสดงตัวอย่างที่ใกล้เคียงก่อน",
      vi: "Khi short chưa truyền được điểm đến, chúng tôi sẽ hiển thị trước một ví dụ gần nhất.",
    },
    days: [
      {
  ...
  paris: {
    ...
    sectionLead: {
      ...
      es: "Continúa el mismo mensaje del short: un viaje, ordenado por fecha y lugar.",
      pt: "Segue a mesma mensagem do short: uma viagem organizada por data e lugar.",
      fr: "On prolonge le message du short : un seul voyage, organisé par date et lieu.",
      th: "ต่อจากข้อความในช็อตส์ทันที จัดหนึ่งทริปตามวันที่และสถานที่",
      vi: "Tiếp đúng thông điệp từ short: một chuyến đi được sắp theo ngày và địa điểm.",
    },
    days: [
      {
        dayLabel: DAY_LABELS.day1,
